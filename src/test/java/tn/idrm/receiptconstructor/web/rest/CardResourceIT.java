...
import tn.idrm.receiptconstructor.service.mapper.CardMapper;
...
class CardResourceIT {
    ...
    public static Card createEntity(EntityManager em) {
        Card card = new Card().type(DEFAULT_TYPE);
        return card;
    }
    ...
    public static Card createUpdatedEntity(EntityManager em) {
        Card card = new Card().type(UPDATED_TYPE);
        return card;
    }
